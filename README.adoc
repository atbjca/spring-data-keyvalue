...
This branch publishes `cn.bjca.footstone.bpring.data:bjca-footstone-bpring-data-keyvalue:2.7.18-nes.patch.1`
to the internal Nexus RELEASE repository. It requires Data Commons
`2.7.18-nes.patch.1` and Spring Framework `5.3.39-nes.patch.1`; all internal
