...
| **依赖前置** | 私服/`~/.m2` 须已存在以下 NES fork 制品：<br>· `cn.bjca.footstone.bpring.data:bjca-footstone-bpring-data-commons:2.7.18-nes.patch.1-SNAPSHOT`<br>· `cn.bjca.footstone.bpring:bjca-footstone-bpring-context:5.3.39-nes.patch.1-SNAPSHOT`<br>· `cn.bjca.footstone.bpring:bjca-footstone-bpring-tx:5.3.39-nes.patch.1-SNAPSHOT` |
...
# 安装到本地仓库
./mvnw -s settings.xml -DskipTests install
```
