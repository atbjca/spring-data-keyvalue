...
- [ ] 4.3 Create the dedicated release commit for `spring-data-keyvalue-2.7` `2.7.18-nes.patch.1`.
...
- [ ] 7.1 Confirm `v2.7.18-nes.patch.1` does not already exist locally or remotely and the target release commit SHA is unchanged.
- [ ] 7.2 Create annotated tag `v2.7.18-nes.patch.1` on the exact release commit only after `nexus-verified`.
